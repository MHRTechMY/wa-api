...
routes.delete('/api/:session/delete-chat', verifyToken, statusConnection, DeviceController.deleteChat);
routes.delete('/api/:session/delete-all-chats', verifyToken, statusConnection, DeviceController.deleteAllChats);
...
routes.delete('/api/:session/delete-message', verifyToken, statusConnection, DeviceController.deleteMessage);
...
routes.delete('/api/:session/remove-participant-group', verifyToken, statusConnection, GroupController.removeParticipant);
...
routes.delete('/api/:session/remove-community-subgroup', verifyToken, statusConnection, CommunityController.removeSubgroupsCommunity);
...
routes.delete('/api/:session/delete-label/:id', verifyToken, statusConnection, LabelsController.deleteLabel);
routes.delete('/api/:session/delete-all-labels', verifyToken, statusConnection, LabelsController.deleteAllLabels);
...
routes.delete('/api/:session/del-collection', verifyToken, statusConnection, CatalogController.deleteCollection);
...
routes.delete('/api/:session/remove-product-image', verifyToken, statusConnection, CatalogController.removeProductImage);
